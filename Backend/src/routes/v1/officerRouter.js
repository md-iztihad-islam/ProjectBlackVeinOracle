...
import { addOfficerController, getAllOfficersController, getOfficersByThanaIdController, signinOfficerController, signoutOfficerController, getOfficersByRankController, updateOfficerController, deleteOfficerController, searchOfficersController, getOfficerByIdController } from '../../controllers/officerController.js'; // by Rayyan 2.0
...
router.get('/get-officer-by-id/:officerId', isAuthenticated, requireRole("admin", "thana"), getOfficerByIdController);
