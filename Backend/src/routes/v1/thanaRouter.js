...
import { addHeadOfficerToThanaController, addThanaContoller, getAllThanasController, getThanaAnalyticsController, getThanasByDistrictController, signinThanaController, signoutThanaController, getThanaByIdController, updateThanaController, deleteThanaController, getThanaByNameController } from '../../controllers/thanaControler.js'; // by Rayyan 2.0
...
router.get('/analytics', isAuthenticated, requireRole("admin", "thana", "officer"), getThanaAnalyticsController);
